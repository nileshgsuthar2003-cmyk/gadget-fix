  ...
  return (
    <Screen>
      <div className="flex-1 px-4 pb-6 pt-5">
        ...
        {/* CTA */}
        <Link to="/book" className="animate-press mt-4 flex items-center justify-between rounded-2xl bg-primary p-5 shadow-[var(--shadow-lifted)]">
          <div>
            <p className="text-lg font-extrabold text-primary-foreground">Book a Repair</p>
            <p className="mt-0.5 text-[13px] text-primary-foreground/75">Free pickup & 6-month warranty</p>
          </div>
